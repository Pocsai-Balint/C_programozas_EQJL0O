...
namespace RaktarProjekt
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //szálakat hozzuk létre, raktar.TermekKivetele futtatjuk
            Thread t1 = new Thread(raktar.TermekKivetele);
            Thread t2 = new Thread(raktar.TermekKivetele);

            //szálakat indítjuk el
            t1.Start();
            t2.Start();

            //várunk, hogy a szálak befejezzék a feladatukat
            t1.Join();
            t2.Join();

            //csak akkor fut ha a t1 és t2 szálak befejezték a feladatukat
